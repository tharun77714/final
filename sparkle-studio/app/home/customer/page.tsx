...
export default function CustomerHome() {
  ...
  useEffect(() => {
    ...
    // Global error handler for Spline buffer errors
  ...
  return (
    <div className="min-h-screen relative bg-black">
      {/* Beautiful Gradient Background with Purple and Orange */}
      <div className="fixed inset-0 w-full h-full z-0 pointer-events-none" style={{ zIndex: 0 }}>
        <div className="w-full h-full bg-gradient-to-br from-black via-purple-900/30 via-orange-900/20 to-black relative overflow-hidden">
          {/* Purple gradient orbs */}
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-purple-600/20 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-purple-500/20 rounded-full blur-3xl"></div>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-purple-700/15 rounded-full blur-3xl"></div>
          ...
          <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-gradient-to-br from-purple-900/10 to-transparent"></div>
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Discover exquisite jewelry collections and connect with premium vendors
          </p>
        </div>
      </section>
      ...
      <section id="gallery" className="py-20 px-4 sm:px-6 lg:px-8 min-h-screen flex items-center">
        <div className="max-w-7xl mx-auto w-full">
          <h2 className="text-4xl md:text-5xl font-bold text-white text-center mb-4">
            Featured <span className="text-purple-400">Collections</span>
          </h2>
          ...
          >
                ...
                {featuredProducts.map((product, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <div className="relative h-[300px] md:h-[350px] bg-gradient-to-br from-purple-900/20 to-gray-900">
                          <img
                            src={product.image}
                            alt={product.name}
                        ...
                        <div className="p-6 bg-gray-800">
                          ...
                          {isActive && (
                            <div className="flex justify-center mt-4">
                              <button className="px-6 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm rounded-lg transition-colors">
                                View Details
                              </button>
                            </div>
                          )}
            ...
            <button
              onClick={prevSlide}
              className="absolute left-4 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-gray-800/80 hover:bg-purple-600 rounded-full flex items-center justify-center text-white transition-all backdrop-blur-sm border border-purple-500/30"
            ...
            <button
              onClick={nextSlide}
              className="absolute right-4 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-gray-800/80 hover:bg-purple-600 rounded-full flex items-center justify-center text-white transition-all backdrop-blur-sm border border-purple-500/30"
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-900/50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-white text-center mb-4">
            Why Choose <span className="text-purple-400">Sparkle Studio</span>
          </h2>
          <p className="text-gray-400 text-center mb-12 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <div
                key={index}
                className="bg-gray-800/50 border border-purple-500/20 rounded-2xl p-6 hover:border-purple-500/50 transition-all hover:transform hover:scale-105 group"
              >
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-br from-purple-600/20 via-purple-800/20 to-gray-900 rounded-3xl p-12 md:p-16 border border-purple-500/30">
            ...
            <Link
              href="/networks"
              className="inline-block px-8 py-4 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-lg transition-all transform hover:scale-105 shadow-lg shadow-purple-500/50"
            >
              Get Started
            </Link>
          </div>
